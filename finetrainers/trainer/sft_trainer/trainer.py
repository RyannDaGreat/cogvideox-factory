...
class SFTTrainer(Trainer):
    ...
    def _prepare_dataset(self) -> None:
        ...
        for config in dataset_configs:
            ...
            auxiliary_data = config.pop("auxiliary_data", None)
            ...
            dataset = data.initialize_dataset(
                dataset_name_or_root, dataset_type, streaming=True, infinite=True, _caption_options=caption_options, auxiliary_data=auxiliary_data,
            )
